...
def clicked():
      ...
      def clicked2():
            ...
            if(pwdtxt.get()==cnfpwdtxt.get()):
                  ...
                  cursor1.execute('''CREATE TABLE IF NOT EXISTS userlogin(uid SERIAL PRIMARY KEY,username Varchar(30),pswd Varchar(20)) ''')
                        ...
                        if(j[0]==unametxt.get() and j[1]==pwdtxt.get()):
                              ...
                              def savefn():
                                    ...
                                    if(doname!="" and username1!="" and password!=""):
                                          ...
                                          cursor1.execute('''CREATE TABLE IF NOT EXISTS passwordmanager(id SERIAL PRIMARY KEY,DomainName Varchar(30),Username Varchar(20),pswd Varchar(20))''')
                                          conn.commit()
